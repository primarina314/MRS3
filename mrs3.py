...
def compress_img_mult_tgs_server(
    ...
    # TODO: 자동 수동 구분 없이 roi_point_lists 로 처리하도록 수정
    ...
    filesize_bef = os.path.getsize(img_path)
    filesize_after = os.path.getsize(pkg_path)
    print(f'before: {filesize_bef}')
    print(f'after: {filesize_after}')
    print(f'compression rate: {filesize_after/filesize_bef}')
